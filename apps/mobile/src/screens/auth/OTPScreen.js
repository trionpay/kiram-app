...
const styles = StyleSheet.create({
  ...
  box: { flex: 1, height: 60, borderRadius: 12, borderWidth: 1.5, borderColor: colors.border, backgroundColor: colors.backgroundElevated, alignItems: 'center', justifyContent: 'center' },
  ...
  footer: { paddingHorizontal: screenPaddingHorizontal, paddingBottom: Platform.OS === 'ios' ? spacing.lg : spacing.xl, paddingTop: spacing.md },
});
