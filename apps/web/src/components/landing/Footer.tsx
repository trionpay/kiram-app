        ...
        <div className="mb-10 grid gap-10 sm:gap-12 md:grid-cols-2 lg:grid-cols-12 lg:gap-x-12">
          ...
          <div className="md:col-span-2 lg:col-span-5">
            ...
            <div className="mt-5 flex gap-3">
              <a href="#" className="flex h-9 w-9 items-center justify-center rounded-lg bg-surface text-text-tertiary transition-colors hover:text-text-primary">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {LINKS.product.map((link, i) => (
                  <li key={i}>
                    <a href={link.href} className="text-sm text-text-tertiary transition-colors hover:text-text-primary">
                      {link.label}
                    </a>
                  </li>
                ))}
