  ...
  return (
    <section id="pricing" className="bg-porcelain py-20">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <FadeIn delay={100}>
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-xl-3 border border-border/50">
            <div className="rounded-xl border border-border bg-porcelain p-6 md:p-7 mb-8">
              <div className="mb-4 flex flex-wrap items-center gap-2">
                <p className="text-text-secondary text-sm font-semibold uppercase tracking-wide">Kısa örnek</p>
                <span className="rounded-lg bg-deep-violet/10 px-2.5 py-1 text-[11px] font-semibold text-deep-violet">
              ...
              <div className="space-y-3">
                ...
                <div className="border-t border-border pt-3 mt-1">
                  <div className="flex justify-between items-center gap-4">
                    ...
                    <span className="text-deep-violet font-bold text-xl tabular-nums">₺10.150</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center pb-8 mb-8 border-b border-border">
              ...
              <div className="inline-flex items-baseline gap-2 flex-wrap justify-center">
                <span className="text-3xl md:text-4xl font-bold text-deep-violet tabular-nums">%1,5</span>
                <span className="text-text-secondary text-base font-medium">/ işlem</span>
              </div>
            </div>

            <div className="grid md:grid-cols-2 gap-4">
              {['Sınırsız işlem', 'Anında transfer', 'Dijital dekont', 'Otomatik ödeme', '7/24 destek', 'Mobil uygulama'].map((item, i) => (
                <div key={i} className="flex items-center gap-3">
                  <span className="w-5 h-5 bg-deep-violet/10 rounded-full flex items-center justify-center text-deep-violet text-xs">✓</span>
            ...
            <div className="mt-8 pt-8 border-t border-border flex flex-col items-center text-center gap-2">
              <Link
                href="/login"
                className="inline-flex w-full sm:w-auto sm:min-w-[240px] items-center justify-center gap-2 bg-deep-violet hover:bg-accent-dark text-white font-semibold text-base px-8 py-4 rounded-lg transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-deep-violet/25"
              >
                Hemen Başla
